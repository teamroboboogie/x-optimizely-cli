...
function LocalController(variation, port, host) {
  ...
  this.locals = {
    ...
    experiment_name: this.experiment.attributes.name,
    variation_name: this.variation.attributes.name
...
LocalController.prototype.installUserScript = function(req, res) {
  res.end(String(ejs.render(
    this.indexTemplate, this.locals
  )));
};
...
LocalController.prototype.userScript = function(req, res) {
  ...
  //Render Userscript
  res.end(String(ejs.render(
    this.installTemplate, this.locals
  )));
};
...
LocalController.prototype.compileLocalCSS = function() {
    var eCSS = this.experiment.getCSS();
    var vCSS = this.variation.getCSS();
    vCSS = eCSS + "\n\n" + vCSS;
    return vCSS;
};
