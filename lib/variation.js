...
Variation.create = function(attrs, baseDir) { //TODO create variation css page_id(s if we want to be able to push variation code to multiple page ids)

  //create directory
  fileUtil.writeDir(baseDir);
  fileUtil.writeText(path.join(baseDir, Variation.JS_FILE_NAME));
  fileUtil.writeText(path.join(baseDir, Variation.CSS_FILE_NAME));
